...
def transform_date():
    raw_data_s3_bucket = "s3://redfin-etl-pipeline-1-data-yml/raw-data-yml/city_market_tracker.tsv000.gz"
    transform_data_s3_bucket = "s3://redfin-etl-pipeline-1-data-yml/transformed-data-yml/redfin_data.parquet"
