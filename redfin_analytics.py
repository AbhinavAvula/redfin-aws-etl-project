...
job_flow_overrides = {
    ...
    "LogUri": "s3://redfin-etl-pipeline-1-data-yml/emr-logs-yml/",
...
SPARK_STEPS_EXTRACTION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": [
                "s3://redfin-etl-pipeline-1-data-yml/scripts/ingest.sh",
            ],
        },
    },
   ]
...
SPARK_STEPS_TRANSFORMATION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": ["spark-submit",
            "s3://redfin-etl-pipeline-1-data-yml/scripts/transform_redfin_data.py",
            ],
        },
    },
   ]
